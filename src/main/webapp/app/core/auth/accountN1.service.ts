...
export class AccountN1Service {
  ...
  fetch(): Observable<HttpResponse<Account>> {
    return this.http.get<Account>(SERVER_API_URL + 'cpiuaa/api/account', { observe: 'response' });
  }

  save(account: any): Observable<HttpResponse<any>> {
    return this.http.post(SERVER_API_URL + 'cpiuaa/api/account', account, { observe: 'response' });
  }
