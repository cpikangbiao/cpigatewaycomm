...
export class CorrespondentSelectPopupService {
    ...
    open(selectCorrespondentPagingParams: any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            this.ngbModalRef.componentInstance.selectCorrespondentPagingParams = selectCorrespondentPagingParams;
