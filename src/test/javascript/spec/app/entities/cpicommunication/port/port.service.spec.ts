    ...
    describe('Port Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'cpicommunication/api/ports';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Port', () => {
                service.create(new Port(null)).subscribe(received => {
            ...
            it('should update a Port', () => {
                service.update(new Port(123)).subscribe(received => {
