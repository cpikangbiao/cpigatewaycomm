...
describe('Service Tests', () => {
    describe('Correspondent Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CorrespondentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'cpicommunication/api/correspondents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Correspondent', () => {
                service.create(new Correspondent(null)).subscribe(received => {
            ...
            it('should update a Correspondent', () => {
                service.update(new Correspondent(123)).subscribe(received => {
            ...
            it('should return a Correspondent', () => {
            ...
            it('should return a list of Correspondent', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Correspondent(123)]);
            });
