...
describe('Component Tests', () => {
    describe('CorrespondentContact Management Component', () => {
        let comp: CorrespondentContactComponent;
        let fixture: ComponentFixture<CorrespondentContactComponent>;
        let service: CorrespondentContactService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CpigatewaycommTestModule],
                declarations: [CorrespondentContactComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CorrespondentContactComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CorrespondentContactComponent);
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new CorrespondentContact(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.correspondentContacts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
